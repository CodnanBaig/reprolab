...
Never commit `.env.local`, MongoDB credentials, captured real-user sessions, personal test credentials or private map data. Use synthetic fixtures. No generated code or imported script should be executed inside the server process.
